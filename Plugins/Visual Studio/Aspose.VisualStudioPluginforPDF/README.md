<p>Aspose.Pdf for .NET Examples Visual Studio plugin is a great tool for quickly downloading and exploring Aspose.Pdf for .NET API examples. We are pleased to announce a new release which supports exploring examples of <a href="http://www.aspose.com/.net/Pdf-component.aspx">Aspose.Pdf for .NET</a>. This plugin saves a lot of time and efforts by providing a very simple option for seamlessly selecting, downloading and opening the latest example projects without having to leave the Visual Studio environment.</p>
<div>
...
<ul>
	<li> <a href="http://www.aspose.com/docs/display/Pdfnet/Aspose.Pdf+Visual+Studio+Plugin#Aspose.PdfVisualStudioPlugin-Downloading">Downloading and Installing </a></li>
	<li> <a href="http://www.aspose.com/docs/display/Pdfnet/Aspose.Pdf+Visual+Studio+Plugin#Aspose.PdfVisualStudioPlugin-VideoDemo">Using and Video Demo</a></li>
</ul>
</div>
